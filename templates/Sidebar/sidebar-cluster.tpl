...
- key: hbf
  ...
  children:
    ...
    - key: hbf-hosts
      label: Hosts
      link: "/{{ $.Values.basePrefix }}/{cluster}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/hosts"
    {{ end }}
    {{ if .items.networks }}
    - key: hbf-networks
      label: Networks
      link: "/{{ $.Values.basePrefix }}/{cluster}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/networks"
    {{ end }}
