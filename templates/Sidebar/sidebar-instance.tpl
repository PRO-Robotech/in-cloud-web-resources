...
- key: hbf
  ...
  children:
    ...
    - key: hbf-rules2ses
      label: RuleS2S
      link: "/{{ $.Values.basePrefix }}/{clusterName}/{namespace}/{syntheticProject}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/rules2s"
    {{ end }}
    {{ with .extraItems }}
      {{ . | toYaml | nindent 4 }}
    {{ end }}
...
- key: hbfsystem
  ...
  children:
    ...
    - key: hbf-ieagagrules
      label: RuleAG2AG
      link: "/{{ $.Values.basePrefix }}/{clusterName}/{namespace}/{syntheticProject}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/ieagagrules"
    {{ end }}
    {{ if .items.servicealiases }}
    - key: hbf-servicealiases
      label: ServiceAliases
      link: "/{{ $.Values.basePrefix }}/{clusterName}/{namespace}/{syntheticProject}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/servicealiases"
    {{ end }}
