...
- key: hbf
  ...
  children:
    ...
    - key: hbf-addressgroups
      label: AddressGroups
      link: "/{{ $.Values.basePrefix }}/{cluster}/{namespace}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/addressgroups"
    {{ end }}
    {{ if .items.services }}
    - key: hbf-services
      label: Services
      link: "/{{ $.Values.basePrefix }}/{cluster}/{namespace}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/services"
    {{ end }}
    {{ if .items.svcsvcrules }}
    - key: hbf-svcsvcrules
      label: SvcSvcRules
      link: "/{{ $.Values.basePrefix }}/{cluster}/{namespace}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/svcsvcrules"
    {{ end }}
...
- key: hbfSystem
  ...
  children:
    ...
    - key: hbf-hostbindings
      label: HostBindings
      link: "/{{ $.Values.basePrefix }}/{cluster}/{namespace}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/hostbindings"
    {{ end }}
    {{ if .items.networkbindings }}
    - key: hbf-networkbindings
      label: NetworkBindings
      link: "/{{ $.Values.basePrefix }}/{cluster}/{namespace}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/networkbindings"
    {{ end }}
    {{ if .items.addressgroupbindings }}
    - key: hbf-addressgroupbindings
      label: AddressGroupBindings
      link: "/{{ $.Values.basePrefix }}/{cluster}/{namespace}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/addressgroupbindings"
    {{ end }}
    {{ if .items.addressgroupportmappings }}
    - key: hbf-addressgroupportmappings
      label: AddressGroupPortMappings
      link: "/{{ $.Values.basePrefix }}/{cluster}/{namespace}/api-table/netguard.sgroups.io/{{ $.Values.addons.hbf.apiVersion }}/addressgroupportmappings"
    {{ end }}
    {{ with .extraItems }}
      {{ . | toYaml | nindent 4 }}
    {{ end }}
...
- children:
    ...
    - key: pods
      label: Pods
      link: /{{ $.Values.basePrefix }}/{cluster}/{namespace}/builtin-table/pods
    {{ end }}
